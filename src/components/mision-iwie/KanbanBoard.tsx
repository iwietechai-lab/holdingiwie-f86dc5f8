...
import { MisionTask, MisionArea } from '@/hooks/useMisionIwie';
...
interface KanbanBoardProps {
  tasks: MisionTask[];
  areas: MisionArea[];
  onCreateTask: (task: Partial<MisionTask>) => Promise<MisionTask | null>;
  onUpdateTask: (id: string, updates: Partial<MisionTask>) => Promise<MisionTask | null>;
  ...
  onCreateArea: (name: string, color?: string) => Promise<MisionArea | null>;
...
export function KanbanBoard({
  ...
  const tasksByPriority = useMemo(() => {
    const grouped: Record<TaskPriority, MisionTask[]> = {
      urgent: [],
      very_important: [],
      important: [],
    };
