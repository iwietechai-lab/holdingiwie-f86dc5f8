  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Datos agregados y anónimos del equipo
          </p>
        </div>
          ...
          <CardContent className="p-4 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Alta proporción de tareas urgentes. Considera revisar prioridades.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <p className="text-xs text-muted-foreground">Tareas Focus</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">Balance de Prioridades</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              {stats && stats.avg_energy >= 4 ? '¡Excelente energía!' :
               stats && stats.avg_energy >= 3 ? 'Buena energía' :
               stats && stats.avg_energy >= 2 ? 'Energía moderada' :
               'Considera revisar cargas'}
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          {hallOfFame.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Aún no hay insignias compartidas
              </p>
            </div>
          )}
        </CardContent>
