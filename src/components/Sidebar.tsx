    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          {/* CEOChat always visible - even when in company mode */}
          {activeCompanyMode && (
            <div className="space-y-2 mb-2">
              ...
              {(() => {
                const isActive = location.pathname === '/ceo-chat';
                const handleClick = () => navigate('/ceo-chat');
                ...
                const button = (
                  ...
                  >
                    ...
                    {!isCollapsed && <span className="truncate">CEOChat</span>}
                  </button>
                );
                ...
                if (isCollapsed) {
                  return (
                    <Tooltip>
                      <TooltipTrigger asChild>{button}</TooltipTrigger>
                      <TooltipContent side="right">CEOChat</TooltipContent>
                    </Tooltip>
                  );
                }
